...
# Author:          Tim Hagmann
# Data Used:       BFS Data
# Packages Used:   dplyer, reshape2, pxR
# Machine:         Lenovo U510 (Ubuntu 12.04)
# Notes:
...
source('E:/99_Software/R/Rprofile.site.32.win')
# source('/media/External-HD/99_Software/R/Rprofile.site.64.linux')

# Librarys
#---------
library(dplyr); library(reshape2); library(pxR)
